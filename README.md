About signac-flow-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/signac-flow-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1909&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/signac-flow-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `signac-flow` can be installed with `conda`:
...
```
mamba install signac-flow
```

It is possible to list all of the versions of `signac-flow` available on your platform with `conda`:
...
```
mamba search signac-flow --channel conda-forge
```
...
mamba repoquery search signac-flow --channel conda-forge

# List packages depending on `signac-flow`:
mamba repoquery whoneeds signac-flow --channel conda-forge

# List dependencies of `signac-flow`:
mamba repoquery depends signac-flow --channel conda-forge
```
